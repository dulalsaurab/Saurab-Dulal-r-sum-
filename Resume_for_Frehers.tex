...
% \name{Gustavo SOUZA VIEIRA DUTRA} % Your name
% \address{156 Kasturi, Balajinagar, Sangli 416416} % Your address
%\address{123 Pleasant Lane \\ City, State 12345} % Your secondary addess (optional)
% \address{(+33)766642429 \\ gsvdutra@gmail.com} % Your phone number and email
\usepackage{hyperref}
% \hypersetup{
%     colorlinks=true,
%     linkcolor=black,
...
% +1 25-566-655-731  dulal.saurab@gmail.com
% [linkedin]/in/dulalsaurab | [github]/dulalsaurab

% \begin{rSection}{\bf{\large{Stage Ingénieur: étudiant à l'ENSMM de Besançon}}}
% \faUser \hspace{0.3cm} \textbf{SAURAB DULAL}\\
% \faPhone \hspace{0.3cm} +256-665-5731\\
% \faAt \hspace{0.3cm} \textbf{dulal.saurab@gmail.com}\\
% \faMapMarker \hspace{0.3cm} 19 - Rue de l'Épitaphe, 25000, Besançon\\
% \faStarO \hspace{0.3cm} 22 ans (24 août 1997)\\
% \faFlagO \hspace{0.3cm} Nacionalité Brésilien
% \end{rSection}
...
% \vspace{-0.4cm}
% \begin{rSection}{Centres d'interêt}
% \vspace{-0.2cm}
% \begin{multicols}{2}
%     \noindent
%         \begin{tabular}{ p{2cm} l}
%         \bf{Sports} &  Basketball et natation\\
%         \bf{Cuisine} & Cuisine brésilienne, française et chinoise\\
%         \bf{Générale} & Lecture, théâtre et musique (piano)
%         \end{tabular}
%     \end{multicols}
